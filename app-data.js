...
const DEMO_USERS = [
  ...
  /* ---- Novos candidatos de teste ---- */
  {
    id: 'u4', type: 'colaborador',
    email: 'maria@email.com', password: 'Teste@2024',
    name: 'Maria', surname: 'Santos',
    role: 'Gestora de Projectos', location: 'Luanda',
    phone: '+244 923 000 001', skills: ['Project Management', 'Scrum', 'Excel', 'PowerPoint'],
    experience: [{ company: 'Sonangol', role: 'Coordenadora de Projectos', years: '2020–2024' }],
    education: [{ school: 'Universidade Agostinho Neto', degree: 'Gestão de Empresas', year: '2019' }],
    about: 'Gestora de projectos com 4 anos de experiência no sector energético angolano.',
    availability: 'open', visibility: 'public', avatar: 'MS',
  },
  {
    id: 'u5', type: 'colaborador',
    email: 'pedro@email.com', password: 'Teste@2024',
    name: 'Pedro', surname: 'Lopes',
    role: 'Desenvolvedor Full Stack', location: 'Luanda',
    phone: '+244 923 000 002', skills: ['React', 'Node.js', 'MongoDB', 'Python'],
    experience: [{ company: 'StartupLDA', role: 'Developer', years: '2021–2024' }],
    education: [{ school: 'ITEL', degree: 'Engenharia Informática', year: '2020' }],
    about: 'Desenvolvedor full stack apaixonado por criar soluções digitais para o mercado africano.',
    availability: 'open', visibility: 'public', avatar: 'PL',
  },
  {
    id: 'u6', type: 'colaborador',
    email: 'sofia@email.com', password: 'Teste@2024',
    name: 'Sofia', surname: 'Nunes',
    role: 'Especialista em Marketing Digital', location: 'Luanda',
    phone: '+244 923 000 003', skills: ['SEO', 'Google Ads', 'Social Media', 'Copywriting'],
    experience: [{ company: 'Unitel', role: 'Marketing Specialist', years: '2022–2024' }],
    education: [{ school: 'Universidade Lusíada de Angola', degree: 'Marketing', year: '2021' }],
    about: 'Especialista em marketing digital com foco em crescimento orgânico e campanhas pagas.',
    availability: 'active', visibility: 'public', avatar: 'SN',
  },

  /* ---- Novas empresas de teste ---- */
  {
    id: 'e4', type: 'empresa',
    email: 'rh@angolafinance.ao', password: 'Teste@2024',
    companyName: 'Angola Finance', sector: 'Finanças',
    location: 'Luanda', website: 'www.angolafinance.ao',
    about: 'Instituição financeira líder em Angola, com foco em soluções bancárias inovadoras para particulares e empresas.',
    benefits: 'Seguro de saúde · Bónus semestral · Formação contínua · Viatura',
    culture: 'Rigor, confiança e inovação. Acreditamos no talento angolano.',
    size: '201-500 colaboradores', founded: '2005',
    avatar: 'AF', coverColor: '#0A45A7',
  },
  {
    id: 'e5', type: 'empresa',
    email: 'rh@techluanda.ao', password: 'Teste@2024',
    companyName: 'TechLuanda', sector: 'Tecnologia',
    location: 'Luanda', website: 'www.techluanda.ao',
    about: 'Empresa de tecnologia angolana focada no desenvolvimento de software e transformação digital de empresas locais.',
    benefits: 'Trabalho híbrido · Stock options · Formação no exterior · Ginásio',
    culture: 'Startuppers com mentalidade africana. Movemo-nos rápido e aprendemos ainda mais rápido.',
    size: '11-50 colaboradores', founded: '2018',
    avatar: 'TL', coverColor: '#7c3aed',
  },
  {
    id: 'e6', type: 'empresa',
    email: 'rh@consultao.ao', password: 'Teste@2024',
    companyName: 'ConsultAO', sector: 'Outro',
    location: 'Luanda', website: 'www.consultao.ao',
    about: 'Consultora de gestão e recursos humanos especializada no mercado angolano e PALOP.',
    benefits: 'Horário flexível · Plano de carreira · Subsídio de alimentação · Seguro de saúde',
    culture: 'Pessoas primeiro. Desenvolvemos líderes e transformamos organizações.',
    size: '51-200 colaboradores', founded: '2012',
    avatar: 'CA', coverColor: '#d97706',
  },
];
